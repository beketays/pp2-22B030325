...
def main():
    ...
    Points_RT  = [(135, 10), (170, 50), (100, 50)]             # 0 - peak, 1 - right, 2 - left
    Points_EqT = [(195, 10), (210, 50), (180, 50)]             # 0 - peak, 1 - right, 2 - left
